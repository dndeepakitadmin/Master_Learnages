 ...
 * Provides foundational data for IDs 1-81 for all 20 languages.
 */
export const MASTER_DICTIONARY: MasterPhrase[] = [
  /* ───────────── 1-10: GREETINGS & BASICS ───────────── */
  { id: 1, category: "Greetings", en_meaning: "Hello", langs: { en: { native: "Hello", latin: "Hello", phonetic_mode: "native" }, hi: { native: "नमस्ते", latin: "Namaste", phonetic_mode: "native" }, kn: { native: "ನಮಸ್ಕಾರ", latin: "Namaskara", phonetic_mode: "native" }, es: { native: "Hola", latin: "Hola", phonetic_mode: "native" }, fr: { native: "Bonjour", latin: "Bonjour", phonetic_mode: "native" }, de: { native: "Hallo", latin: "Hallo", phonetic_mode: "native" }, ja: { native: "こんにちは", latin: "Konnichiwa", phonetic_mode: "native" }, ko: { native: "안녕하세요", latin: "Annyeonghaseyo", phonetic_mode: "native" }, zh: { native: "你好", latin: "Nǐ hǎo", phonetic_mode: "native" }, ar: { native: "مرحبًا", latin: "Marhaban", phonetic_mode: "native" } } },
  { id: 2, category: "Greetings", en_meaning: "How are you?", langs: { en: { native: "How are you?", latin: "How are you?", phonetic_mode: "native" }, hi: { native: "आप कैसे हैं?", latin: "Aap kaise hain?", phonetic_mode: "native" }, kn: { native: "ಹೇಗಿದ್ದೀರಾ?", latin: "Hegiddira?", phonetic_mode: "native" } } },
  { id: 3, category: "Greetings", en_meaning: "I am fine", langs: { en: { native: "I am fine", latin: "I am fine", phonetic_mode: "native" }, hi: { native: "मैं ठीक हूँ", latin: "Main theek hoon", phonetic_mode: "native" } } },
  { id: 4, category: "Basics", en_meaning: "Thank you", langs: { en: { native: "Thank you", latin: "Thank you", phonetic_mode: "native" }, hi: { native: "धन्यवाद", latin: "Dhanyavaad", phonetic_mode: "native" } } },
  { id: 5, category: "Basics", en_meaning: "Please", langs: { en: { native: "Please", latin: "Please", phonetic_mode: "native" }, hi: { native: "कृपया", latin: "Kripya", phonetic_mode: "native" } } },
  { id: 6, category: "Basics", en_meaning: "Excuse me", langs: { en: { native: "Excuse me", latin: "Excuse me", phonetic_mode: "native" }, hi: { native: "क्षमा करें", latin: "Kshama karein", phonetic_mode: "native" } } },
  { id: 7, category: "Basics", en_meaning: "Yes", langs: { en: { native: "Yes", latin: "Yes", phonetic_mode: "native" }, hi: { native: "हाँ", latin: "Haan", phonetic_mode: "native" } } },
  { id: 8, category: "Basics", en_meaning: "No", langs: { en: { native: "No", latin: "No", phonetic_mode: "native" }, hi: { native: "नहीं", latin: "Nahi", phonetic_mode: "native" } } },
  { id: 9, category: "Basics", en_meaning: "Goodbye", langs: { en: { native: "Goodbye", latin: "Goodbye", phonetic_mode: "native" }, hi: { native: "नमस्ते", latin: "Namaste", phonetic_mode: "native" } } },
  { id: 10, category: "Common", en_meaning: "I want water", langs: { en: { native: "I want water", latin: "I want water", phonetic_mode: "native" }, hi: { native: "मुझे पानी चाहिए", latin: "Mujhe paani chahiye", phonetic_mode: "native" } } },
  ...
  /* ───────────── 67-70: LOCATIONS ───────────── */
  { id: 67, category: "Common", en_meaning: "It / This", langs: { en: { native: "It", latin: "It", phonetic_mode: "native" } } },
  { id: 68, category: "Common", en_meaning: "That", langs: { en: { native: "That", latin: "That", phonetic_mode: "native" } } },
  { id: 69, category: "Common", en_meaning: "Here", langs: { en: { native: "Here", latin: "Here", phonetic_mode: "native" } } },
  { id: 70, category: "Common", en_meaning: "There", langs: { en: { native: "There", latin: "There", phonetic_mode: "native" } } },
